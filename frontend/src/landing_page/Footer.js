    ...
    >
      <div className="row mt-5">
        <div className="col">
          ...
          <i class="fa-brands fa-twitter mx-3 fs-4"></i>
          <i class="fa-brands fa-facebook mx-3 fs-4"></i>
          <i class="fa-brands fa-instagram mx-3 fs-4"></i>
          <i class="fa-brands fa-linkedin mx-3 fs-4"></i>
          <i class="fa-brands fa-telegram mx-3 fs-4"></i>
        </div>
        <div className="col ">
          <p>Company</p>
